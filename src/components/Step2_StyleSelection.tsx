  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3 mt-3">
        ...
        <div className="flex items-center gap-3 text-gray-400 text-sm border-t border-white/10 pt-2 mt-2">
  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col space-y-6 animate-fade-in">
      ...
      <div className="glass-effect p-4 rounded-lg mt-6">
        <h3 className="font-bold text-gray-200 mb-2"><i className="fas fa-paste mr-2 text-cyan-400"></i>Ou cole seu próprio prompt de estilo:</h3>
        <div className="flex gap-2">
            <input 
                type="text" 
                value={customStyleInput} 
                onChange={e => setCustomStyleInput(e.target.value)} 
                placeholder="Ex: 8-bit pixel art, vibrant colors, NES-style..."
                className="input-neon flex-grow p-2 rounded-md"
            />
            <button 
                onClick={() => {
                    if(customStyleInput.trim()) {
                        onConfirmCustomStyle(customStyleInput.trim());
                    }
                }} 
                disabled={!customStyleInput.trim()} 
                className="btn-secondary-neon !py-2 !px-4"
            >
                Usar
            </button>
        </div>
